...
function loadReqInfo(invo_id, cust_phone, cust_name) {
  $.ajax({
    type: "post",
    url: url(),
    data: {
    ...
    success: function (response) {
      ...
      $.each(response, function (i, value) {
        ...
        $('#oneCustNumber').val(cust_phone)
        $('#oneCustNumber').val(oneCustName)
        $('.generalWraper').hide();
...
$("#smsOneCust").click(function (e) { 
  e.preventDefault();
  let oneCustNumber = $('#oneCustNumber').val();
  let oneCustName = $('#oneCustName').val();
