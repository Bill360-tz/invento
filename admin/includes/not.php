<div class="flex width-50 flex-s-btn">
    <a href="sale" class="saleBtn text-w anchor">[sale]</a>
    ...
    <div class="">
        ...
        <div id="profileDropDown">
            <!-- Dropdown content goes here -->
            <a class="theme-text-c w-500" href="setting"><i class="fa fa-user-circle" aria-hidden="true"></i> Your Profile</a>
            <a class="theme-text-c w-500" href="logout"><i class="fa fa-power-off" aria-hidden="true"></i> Log Out</a>
        </div>
    </div>
</div>