                        ...
                        <div class="general flex-c fill grid-gap-10  fill">
                            <div class="flex-c gap-10">
                                <div class="flex-c bg-w shadow-pri rad-3 pad-10">
                                    <h4 class="theme-text">OUTSTANDING INVOICE</h4>
                                    <span class="size-1_4rem w-500 theme-text-c text-c font-four"><?= outstandingInvo()['invoiceSum'] ?></span>
                                    <span class="fill theme-text-c text-r"><a href="outstanding-invoices" class="btn-pri-o">View All <i class="fa fa-arrow-right" aria-hidden="true"></i></a></span>
                                </div>
                                <div class="flex-c bg-w shadow-pri rad-3 pad-10" ">
                            ...
                            <div class="flex-c gap-10" style="display: none;">
